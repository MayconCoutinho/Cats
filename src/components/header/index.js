        ...
        <header className={styles.header_bar}>
            <div className={styles.container}>
                ...
                <nav className={styles.menu}>
                    <ul>
                        <li>
                            <a id={styles.a_home} href="#">
                                {" "}
                                Home{" "}
                            </a>
                        </li>
                        <li>
                            <a id={styles.a_create} href="#">
                                Create{" "}
                                <svg
                    ...
                    <ul>
                        <li>
                            <a href="#">
                                <div
                                    key={"circulo cinza"}
                                    id={styles.circulo_cinza}
                                >
                                    <svg
                                        key={"notificar"}
                                        id={styles.svg_notification}
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="30"
                                        height="30"
                                        viewBox="0 0 24 24"
                                ...
                                >
                                    ...
                                    >
                                        <path
                                            ...
                                            d="m43.51 36.19l-.55-2A21.5 21.5 0 1 0 34.14 43l2 .55l7.2 1.93a1.67 1.67 0 0 0 2-1.18a1.61 1.61 0 0 0 0-.87Zm-10-14.39a2.2 2.2 0 1 1-2.2 2.2a2.23 2.23 0 0 1 2.22-2.2Zm-19.04 4.4a2.2 2.2 0 1 1 2.2-2.2a2.23 2.23 0 0 1-2.2 2.2Zm9.53 0a2.2 2.2 0 1 1 2.2-2.2a2.23 2.23 0 0 1-2.2 2.2Z"
                                        />
                                    </svg>
                                </div>
                            </a>
                        ...
                        <li>
                            <a href="#">
                                ...
                                >
                                    <Image
                                        alt="perfil"
                                        src="/assets/img/perfil/perfil.jpg"
                                        width="28px"
                                        height="28px"
                                        layout="fixed"
                                    />
